...
export function getAllProperties(http: HttpClient, rootUrl: string, params?: GetAllProperties$Params, context?: HttpContext): Observable<StrictHttpResponse<BaseResponseDtoListTenant>> {
