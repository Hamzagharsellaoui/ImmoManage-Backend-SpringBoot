...
import { getAllProperties } from '../fn/tenant-controller/get-all-properties';
import { GetAllProperties$Params } from '../fn/tenant-controller/get-all-properties';
...
export class TenantService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  getAllProperties$Response(params?: GetAllProperties$Params, context?: HttpContext): Observable<StrictHttpResponse<BaseResponseDtoListTenant>> {
   ...
   * This method doesn't expect any request body.
   */
  getAllProperties(params?: GetAllProperties$Params, context?: HttpContext): Observable<BaseResponseDtoListTenant> {
